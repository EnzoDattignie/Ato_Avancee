...
int main (int argc, char * argv[]) {
  ...
  FILE *file, *log;
  int *Liste;
  file = fopen("/home/dattigniee/scratch_dattigniee/TP1B/input_N4096.xyz","r");
  log  = fopen("/home/dattigniee/scratch_dattigniee/TP1B/output.log","w");
  ...
  ListeVerlet(n,ndim, rverlet, pos,box,Liste);  forces(ndim,n,rc,box,pos,forc,&epot,Liste);
